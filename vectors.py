...
import numpy as np
class Vector:
    def __init__(self,start_point=np.array([0,0,0]), end_point=np.array([0,0,0]), display_on_screen=True, color='black'):
    ...
    def projectOnVector(self, compared_vector):
        ...
        return Vector(end_point=projected_vector)
    ...
    def projectOnPlane(self, x_vector, y_vector):
        ...
        normal_vector = Vector([0,0,0],normal_vector)
        ...
        return Vector(end_point=[self.vector - projected_vector.vector])
    ...
    def get2dCoordinates(self, x_unit_vector, y_unit_vector):
        ...
        if (screen_vector.vector == np.array([0,0,0])).all():
            return [0, 0]
        ...
        x_position = (x_vector.vector[0] / x_unit_vector.vector[0])
        y_position = (y_vector.vector[1] / y_unit_vector.vector[1])
...
class Triangle:
    def __init__(self, v1, v2, v3=None):
        self.v1 = v1
        self.v2 = v2
        self.v3 = Vector(v1.end_pont, v2.end_point)
